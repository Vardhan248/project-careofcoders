...
const docref = await collection(db, "CSharp_questions")
...
submitBtn.addEventListener('click', async() => {
    ...
    if(answer) {
       ...
       if(currentQuiz < quizData.length) {
        ...
        <center><button onclick="location.reload()">Replay</button> <button onclick="window.location.href='java_see_answers.html';">See Answers</button> </center> 
            </div>
           `
       }
    }
