...
const docref = await collection(db, "C_questions")
...
submitBtn.addEventListener('click', async() => {
    ...
    if(answer) {
       ...
       if(currentQuiz < quizData.length) {
        ...
        <center><button onclick="location.reload()">Replay</button> <button onclick="window.location.href='c_see_ans.html';">See Answers</button> </center> 
            </div>
           `
       }
    }
